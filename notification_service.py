...
class NotificationService:
    ...
    def send_approval_request_notification(self, approvers: list, request_data: Dict[str, Any], 
        ...
        """
        subject = f"Transaction Approval Request - {request_data.get('account_name', 'Unknown Account')}"
        ...
        text_message = f"""Transaction Approval Request
        
Account: {request_data.get('account_name', 'Unknown')}
Requested by: {request_data.get('requested_by', 'Unknown')}
Max Amount: ${request_data.get('max_amount', 'Unlimited')}
Valid: {request_data.get('approval_start_date', 'Unknown')} to {request_data.get('approval_end_date', 'Unknown')}

Click to view details and approve/deny."""
        ...
        for approver in approvers:
            ...
            # Send Pushover if user key is available
