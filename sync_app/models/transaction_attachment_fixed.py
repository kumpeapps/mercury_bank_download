...
class TransactionAttachment(Base):
    ...
    def is_url_expired(self):
        ...
        from simple_timezone_fix import get_naive_now, safe_naive_datetime_compare, make_naive
        return safe_naive_datetime_compare(get_naive_now(), make_naive(self.url_expires_at)) > 0
